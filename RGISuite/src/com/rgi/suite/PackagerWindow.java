...
public class PackagerWindow extends JFrame
{
    ...
    private void buildContentPane()
    {
        ...
        inputFileNameButton.addActionListener(e -> { final String startDirectory = PackagerWindow.this.settings.get(LastInputLocationSettingName, SettingsWindow.DefaultOutputLocation);
                                                     ...
                                                     if(option == JFileChooser.APPROVE_OPTION)
                                                     {
                                                         ...
                                                         try
                                                         {
                                                             PackagerWindow.this.inputFileChanged(file);
                                                         }
         ...
         final JButton okButton = new JButton(new AbstractAction()
                                             {
                                                 ...
                                                 public void actionPerformed(final ActionEvent event)
                                                 {
                                                    ...
                                                    {
                                                        ex.printStackTrace();
                                                        JOptionPane.showMessageDialog(PackagerWindow.this, "Packaging", "An error has occurred: " + ex.getMessage(), JOptionPane.ERROR_MESSAGE);
                                                    }
                                                 }
                                             });
