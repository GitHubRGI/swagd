 ...
 *
 */
public class TmsTileStoreWriter extends TmsTileStore implements TileStoreWriter
{
    /**
     * Constructor
     *
     ...
     */
    public TmsTileStoreWriter(final TileProfile profile, final Path location)
    {
