...
package com.rgi.erdc.tile.store;
...
public interface TileStore
{
	 ...
	 * @return A Tile object loaded with the tile requested.
	 * @throws TileStoreException
	 *             A TileStoreException occurs if either the tile does not exist
	 *             or another error occurs during tile retrieval.
	 */
	public Tile getTile(final AbsoluteTileCoordinate coordinate) throws TileException, TileStoreException;
	 ...
	 */
	public Tile addTile(final AbsoluteTileCoordinate coordinate, final BufferedImage image) throws TileException, TileStoreException;
